package org.rvinowise.game_engine;


import java.util.Collection;

import org.rvinowise.game_engine.opengl.matrices.Matrix;
import org.rvinowise.game_engine.opengl.matrices.Projection_matrix;
import org.rvinowise.game_engine.opengl.matrices.View_matrix;
...
public class Viewport {
    ...
    public Field_dimention getField_dimention() {
        return Field_dimention.fromRectangle(getRect());
    }
